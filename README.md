...
**本书是[《ECMAScript标准》](https://tc39.es/ecma262/multipage/)的“说明书”，系统地介绍了标准的阅读规则以及使用方式。** 通过阅读本书，读者能够完全掌握理解标准的能力，并最终得以使用这个世界上最好的JavaScript资料来解决日常工作问题、进阶个人编码能力。
...
我目前在找工作，前端开发，可base深圳、广州、香港，当然也可远程办公，有合适岗位的朋友可联系邮箱：cxz40901993@gmail.com，感激不尽🙏。
